...
/**
 * Klient OpenAI – używa klucza z .env (OPENAI_API_KEY)
 */
...
/**
 * System prompt, który opisuje NPC + śledztwo / poziom.
 */
...
function registerAiDialogRoutes(app) {
  app.post('/ai/dialog', async (req, res) => {
    try {
      ...
      // 1) System prompt z rolą NPC + lore poziomu
      messages.push({
        role: 'system',
