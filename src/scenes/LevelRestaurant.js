      ...
      characters: [
        {
          ...
          src: character1,
          npcId: 'alicja',
          text: 'Nie przestawiałam niczyjego kieliszka.',
...

        {
          ...
          src: character2,
          npcId: 'michal',
          text: 'Na chwilę wyszedłem odebrać telefon.',
...

        {
          ...
          src: character3,
          npcId: 'weronika',
          text: 'Widziałam dużo, ale nie wszystko powiem…',
...

        {
          ...
          src: character4,
          npcId: 'rafal',
          text: 'Nie dotykałem cudzych kieliszków.',
...

        {
          ...
          src: character5,
          npcId: 'jakub',
          text: 'Spokojnie, spróbujmy odtworzyć kolejność.',
