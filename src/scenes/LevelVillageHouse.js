...
Twoim zadaniem jest odkrycie, który z czterech podejrzanych miał motyw i okazję, by zamordować gospodarza i szukał ukrytych dokumentów. Przeanalizuj sprzeczne zeznania, momenty wejścia i wyjścia z domu oraz to, kto naprawdę miał dostęp do kominka i ksiąg.`,
      ...
      characters: [
        { key: 'character1', src: character1, text: 'Chciałam tylko pożyczyć podręczniki…', avatar: { key: 'avatar1', src: avatar1 } },
        { key: 'character2', src: character2, text: 'Przyjechałem po wskazówki do pracy.',  avatar: { key: 'avatar2', src: avatar2 } },
        { key: 'character3', src: character3, text: 'Interesował mnie stary wóz, serio.',   avatar: { key: 'avatar3', src: avatar3 } },
        { key: 'character4', src: character4, text: 'Tylko pomagałem przy kominku.',        avatar: { key: 'avatar4', src: avatar4 } },
        { key: 'character5', src: character5, text: 'Ktoś wyskoczył przez okno… bałem się.', avatar: { key: 'avatar5', src: avatar5 } },
      ],
